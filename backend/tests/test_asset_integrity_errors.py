...
# test_update_asset_duplicate_asset_code_returns_400_not_500 lives in
# tests/test_asset_detail.py (update_asset moved to app.api.asset_detail
# during the router split). _IntegrityErrorFakeDB is duplicated there too —
# small enough not to warrant a shared-fixture extraction for two call sites.
