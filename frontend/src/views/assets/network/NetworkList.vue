      ...
      <div class="flex-1">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
          <table class="data-table">
            ...
            <tbody>
              <tr v-if="loading"><td colspan="7" class="text-center py-8 text-slate-500">加载中...</td></tr>
              <tr v-else-if="assets.length === 0"><td colspan="7" class="text-center py-8 text-slate-500">暂无数据</td></tr>
